...
class Post extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('tags', 'match', 'pattern'=>'/^[\w\s,]+$/', 'message'=>Yii::t('attributeLabels','Tags can only contain word characters.')),
	...
	public function attributeLabels()
	{
		return array(
			...
			'tags' => Yii::t('attributeLabels','Tags'),
			...
			'author_id' => Yii::t('attributeLabels','Author'),
		);
	}
