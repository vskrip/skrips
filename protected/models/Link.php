...
class Link extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, act_type, name, url', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'acttype' => array(self::BELONGS_TO, 'Acttype', 'act_type'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'act_type' => Yii::t('attributeLabels','Type of Activity'),
			'name' => Yii::t('attributeLabels','Name'),
			'url' => 'Url',
		);
	}
